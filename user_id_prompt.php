...
<div data-role="collapsibleset">
  <div data-role="collapsible">
    ...
    <form id='new_survey_form' class='tt-form' method="post" action="start_new_survey.php">
      ...
      <input type="text" name="user_name" id="user_name" placeholder="Your name here...">
      <?php if($tt_nojs) { print "<br class='nospace'>"; }; ?>
      <label for="user_email">Email:</label>
      <input type="text" email="user_email" id="user_email" placeholder="(optional)">
      <p class='tt-form-note'>The email address is optional. It will be used to send you a confirmation of your survey responses and a link that will allow you to revisit, complete, or update your responses.</p>
      <div class=submit><input id='start_survey_button' type="submit" value="Start Survey..."></div>
    </form>
  </div>
  <div data-role="collapsible">
    <h2>Resume an existing survey</h2>
      <form id="resume_survey_form" class='tt-form' method='post' action="resume_new_survey.php">
      ...
      <input type='text' name='user_id' id='user_id' placeholder="XXX-XXX-XXX-XXX">
