...
CREATE TABLE `response_participation_options` (
  ...
  KEY `item_id_2` (`item_id`,`option_id`),
...
CREATE TABLE `survey_items` (
  ...
  `label` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `qualification_label` varchar(255) CHARACTER SET utf8 COLLATE utf8_spanish_ci DEFAULT NULL,
...
CREATE TABLE `survey_participation_options` (
  `item_id` int(11) NOT NULL,
  `option_id` int(11) NOT NULL,
  `option_label` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL,
...
-- Dump completed on 2017-05-28 17:38:23
